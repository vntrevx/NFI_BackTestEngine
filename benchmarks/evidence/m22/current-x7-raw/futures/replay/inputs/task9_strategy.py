...
class CurrentLongGrindRescueContract(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "5m"
    ...
    def populate_entry_trend(self, dataframe, metadata):
        ...
        dataframe.loc[
            dataframe["date"] == pd.Timestamp("2022-03-29 12:10:00+00:00"),
    ...
    def populate_exit_trend(self, dataframe, metadata):
        ...
        dataframe.loc[
            dataframe["date"] == pd.Timestamp("2022-04-11 10:05:00+00:00"),
            ["exit_long", "exit_tag"],
        ] = (1, "exit_signal")
        return dataframe
