...
NATIVE_SCORE_RAW_EVIDENCE_V2_SCHEMA = "native-score-raw-evidence-v2.schema.json"
NATIVE_SCORE_MACHINE_RECORD_V2_SCHEMA = "native-score-machine-record-v2.schema.json"
