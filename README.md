...
| Current `main` | v1.3.0 product release source; no new combined Full X7 certification claim |
...
The latest public installer and a source checkout of `main` return `nfi-bte 1.3.0`.
