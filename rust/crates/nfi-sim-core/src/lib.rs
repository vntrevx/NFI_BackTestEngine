...
mod calculations;
use calculations::{
    available_stake_amount, ceil_step, duration_ns, entry_order_side, entry_sizing, exact_rational,
    exit_order_side, fee_close, fee_open, floor_step, ft_precise_division,
    logical_pair_event_count, pairwise_sum, precise_product, precise_product_quotient, precise_sum,
    python_float_sum, round_eight, round_step, scheduled_cursor,
};
mod domain;
