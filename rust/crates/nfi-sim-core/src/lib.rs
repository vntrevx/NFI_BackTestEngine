...
#[cfg(test)]
use calculations::{
    ceil_step, entry_sizing, exact_rational, floor_step, ft_precise_division, pairwise_sum,
    precise_product, precise_product_quotient, round_eight, round_step,
};
use calculations::{fee_close, fee_open, python_float_sum};
mod domain;
mod io;
...
mod portfolio;
mod validation;
use portfolio::{OpenTrade, TradeSide};
mod futures;
#[cfg(test)]
use futures::evaluate_nfi_leverage;
use futures::{
    entry_leverage, preserve_partial_exit_funding_refresh,
...
pub use domain::*;
use execution::{adjustment_minimum_pair_stake, current_profit_ratio};
#[cfg(test)]
use execution::{
    enter_trade, evaluate_confirm_program, evaluate_exit_confirm_program, evaluate_stake_program,
    exit_decision, minimum_pair_stake, pair_price_step, ConfirmInputs, EntryRequest, EntryStake,
    StakeInputs,
};
use validation::{
